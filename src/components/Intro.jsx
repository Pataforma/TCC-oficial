...
const Intro = () => {
    return (
      <section className="container d-flex flex-column flex-lg-row justify-content-beetween my-5 px-5 espacamento-header mb-0 pb-0" >
        ...
        <div className="position-relative w-100 w-lg-50 text-center mt-4 mt-lg-0">
          ...
          <img src={cachorro} alt="Cachorro" className="img-fluid intro-dog w-100" />
        </div>
      </section>
    );
  };
