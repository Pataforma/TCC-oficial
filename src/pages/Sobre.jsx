            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center">
                  <div className="rounded-circle bg-main d-flex align-items-center justify-content-center mx-auto mb-3" style={{ width: "80px", height: "80px" }}>
                    <i className="bi bi-heart-fill text-white fs-3"></i>
                  </div>
                  <h4 className="text-elements">Cuidado</h4>
                  <p>
                    Colocamos o bem-estar dos animais em primeiro lugar, promovendo práticas
                    responsáveis de cuidado e atenção às suas necessidades.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body text-center">
                  ...
                  <p>
                    Construímos relações baseadas na transparência e confiabilidade,
                    garantindo um ambiente seguro para tutores e profissionais.
                  </p>
                </div>
              </div>
            </div>
